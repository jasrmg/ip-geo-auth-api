...
if (envVars.JWT_SECRET.length < 32) {
  console.warn(
    "⚠️  WARNING: JWT_SECRET is too short (should be at least 32 characters)"
  );
  console.warn(
...
console.log(
  `✅ JWT_SECRET configured (${envVars.JWT_SECRET.length} characters)`
);
...
if (envVars.IPINFO_TOKEN) {
  ...
  console.log("ℹ️  IPINFO_TOKEN not set (optional - using free tier)");
}
